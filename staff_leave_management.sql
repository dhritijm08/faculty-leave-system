...
INSERT INTO `leave_requests` (`id`, `faculty_id`, `role`, `leave_type`, `date_from`, `date_to`, `days`, `reason`, `status`, `hod_status`, `dean_status`, `principal_status`, `forwarded_to`, `department`, `created_at`, `remarks`, `hod_remarks`, `dean_remarks`, `principal_remarks`) VALUES
(1, 1, 'Faculty', 'Casual Leave', '2025-04-17', '2025-04-19', 3, 'sick', 'approved', 'approved', 'approved', 'pending', 'principal', 'M.Sc. Data Science', '2025-04-16 16:27:20', NULL, NULL, NULL, NULL),
(2, 3, 'Dean', 'emergency', '2025-04-18', '2025-04-19', 2, 'sick2.0', 'approved', 'pending', 'pending', 'pending', 'principal', 'M.Sc. Data Science', '2025-04-16 16:28:20', NULL, NULL, NULL, NULL),
(3, 2, 'HOD', 'emergency', '2025-04-17', '2025-04-25', 9, 'sick1.0', 'rejected', 'pending', 'pending', 'pending', 'dean,principal', 'M.Sc. Data Science', '2025-04-16 16:29:00', NULL, NULL, NULL, NULL),
(4, 2, 'HOD', 'emergency', '2025-04-16', '2025-04-24', 9, 'testing ', 'rejected', 'pending', 'pending', 'pending', 'dean,principal', 'M.Sc. Data Science', '2025-04-16 16:32:15', NULL, NULL, NULL, NULL);
